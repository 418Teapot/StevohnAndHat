...
public class WiiMoteTest : MonoBehaviour {
	...
	void Update () {
        ...
        Wiimote wiiMote1 = receiver.wiimotes[1];
        Debug.Log("WII MOTE - Pitch: " + wiiMote1.PRY_PITCH + " Yaw: " + wiiMote1.PRY_YAW + " Roll: " + wiiMote1.PRY_ROLL);
        Debug.Log("NUNCHUCK - C: " + wiiMote1.NUNCHUK_C.ToString() + " Z: " + wiiMote1.NUNCHUK_Z + "Joystick: "+wiiMote1.NUNCHUK_JOY_X+", "+wiiMote1.NUNCHUK_JOY_Y);
        Debug.Log("NUNCHUCK - C: " + wiiMote1.NUNCHUK_C.ToString() + " Z: " + wiiMote1.NUNCHUK_Z);
